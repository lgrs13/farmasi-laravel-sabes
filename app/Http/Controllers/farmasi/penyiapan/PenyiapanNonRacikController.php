...
class PenyiapanNonRacikController extends BaseController
{
        ...
        foreach ($resep_ranap as $data) {
            ...
            array_push(
                ...
                array(
                    ...
                    'datetime_kemas' => $data->datetime_kemas,
                )
            );
        }
