                    ...
                    var Table = $('#tableResep1').dataTable({
                        ...
                        "columns": [
                            ...
                            },
                            {
                                ...
                                "mRender": function (data, type, full) {
                                    var result = '';
                                    if (data.datetime_racik) {
                                        
                                        result += '<span class="badge bg-info">Racik</span>';
                                    }else{
                                        result += '<span class="badge bg-primary">Non Racik</span>';
                                    }
                                    return result;
                            ...
                            },
                            {
                                ...
                                "mRender": function (data, type, full) {
                                    var result = '';
                                    result += '<span class="badge bg-success">' + data.datedif + '</span>';
                                    return result;
