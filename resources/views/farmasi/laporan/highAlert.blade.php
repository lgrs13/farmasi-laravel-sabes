...
@section('title')
<title>Laporan | High Alert</title>
@endsection
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive datatable-minimal ">
                    <table class="table" id="tableObat1">
                        <thead>
                            <tr>
                                <th>Kode Barang</th>
                                <th>Nama Barang</th>
...
<script>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.code == 200) {
                    $("#tableObat1").DataTable().destroy()
                    var Table = $('#tableObat1').dataTable({
                        "aaData": response.data_obat,
                        "columns": [
                            {
                                "data": "kode_barang"
                            },
    ...
    $('#tableObat1').on('click', '.btnPenyerahan', function () {
