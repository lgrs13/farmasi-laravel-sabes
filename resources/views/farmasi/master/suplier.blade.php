...
@section('script')
    ...
    <script>
                                ...
                                "columns": [{
                                    ...
                                    },
                                    {
                                        ...
                                        "mRender": function(data, type, full) {
                                            var result = '';
                                            result += data.nama_bank + '<br>'
                                            result += data.rekening + ''
                                            return result;
                                    ...
                                    },
                                    {
                                        ...
                                        "mRender": function(data, type, full) {
                                            ...
                                            button += 'data-kodesuplier="' + data.kode_suplier + '"';
                                            button += 'data-namasuplier="' + data.nama_suplier + '"';
                                            button += 'data-alamat="' + data.alamat + '"';
                                            button += 'data-kota="' + data.kota + '"';
                                            button += 'data-notelp="' + data.no_telp + '"';
                                            button += 'data-namabank="' + data.nama_bank + '"';
                                            button += 'data-rekening="' + data.rekening + '"';
        ...
        $('#table1').on('click', '.btnEdit', function() {
            $('#kode2').val($(this).data('kodesuplier'));
            $('#nama2').val($(this).data('namasuplier'));
        ...
        $('#btnsaveobat').click(function(e) {
            ...
            if ($('#nama1').val() == '') {
                ...
                $.ajax({
                    url: "/suplier/postData",
                    type: 'POST',
                    data: {
                        nama_suplier: $('#nama1').val(),
                        alamat: $('#alamat1').val(),
                        kota: $('#kota1').val(),
                        no_telp: $('#tlp1').val(),
                        nama_bank: $('#bank1').val(),
                        rekening: $('#rekening1').val(),
                    },
                    dataType: 'json',
                    success: function(response) {
                        console.log(response);
