...
@section('title')
    <title>Persiapan | Resep Non-Racik</title>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6 ">
                            <h4 class="card-title">Resep Dokter Non Racik</h4>
                        </div>
                    </div>
                    <div class="row">
...
@section('script')
    ...
    <script>
        ...
        function getResep() {
            ...
            $.ajax({
                url: "/persiapannonracik/getResep",
                type: 'POST',
                data: {
        ...
        $('#btnsavepenyerahan').click(function(e) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "/persiapannonracik/postSimpanResep",
                        type: 'POST',
                        data: {
