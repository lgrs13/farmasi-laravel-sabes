...
@section('title')
    <title>Persiapan | Penyerahan</title>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6 ">
                            <h4 class="card-title">Penyerahan</h4>
                        </div>
                    </div>
                    <div class="row">
...
@section('script')
    ...
    <script>
                    ...
                    if (response.code == 200) {
                        ...
                        var Table = $('#tableResep1').dataTable({
                            ...
                            "columns": [{
                                ...
                                },
                                {
                                    ...
                                    "mRender": function(data, type, full) {
                                        ...
                                        // if (data.datetime_penyerahan == null) {
                                        ...
                                        result += 'data-jumlahresep="' + data.jumlah_resep + '"';
                                        result += 'data-statusrawat="Ralan"';
                                        result += '><i class="bi bi-bucket-fill"></i></button>';


                                        // if (data.stts_resep != 'Selesai') {
                                        result += '<button type="button" id="btnSelesai" class="btn btn-sm btn-success btnSelesai ms-2"';
                                        result += 'data-noresep="' + data.no_resep + '"';
                                        result += 'data-tglperesepan="' + data.tgl_peresepan + '"';
                                        result += 'data-jamperesepan="' + data.jam_peresepan + '"';
                                        result += 'data-norawat="' + data.no_rawat + '"';
                                        ...
                                        // result += 'data-no_antri="' + data.no_rkm_medis + '"';
                                        result += 'data-kdpoli="' + data.kd_poli + '"';
                                        result += 'data-nmdokter="' + data.nm_dokter + '"';
                                        result += 'data-nmpoli="' + data.nm_poli + '"';
                                        result += 'data-jumlahresep="' + data.jumlah_resep + '"';
                                        result += 'data-statusrawat="Ralan"';
                                        result += '><i class="bi bi-megaphone-fill"></i></button>';
                                        // }
                                        result += '</div>';
                                        return result;
                            ...
                            "createdRow": function(row, data, index) {
                                ...
                                } else if (data.jumlah_resep > 1) {
                                    $(row).addClass('table-info'); //Original Date
                                }
        ...
        $('#tableResep1').on('click', '.btnPenyerahan', function() {
            ...
            // console.log($(this).data('jumlahresep'));

            if ($(this).data('jumlahresep') > 1) {
                Swal.fire({
                    title: "Periksa Kembali resep",
                    text: "Pasien memiliki lebih Dari 1 resep, periksa kembali data sebelum obat di serahkan ke Pasien",
                    icon: "info",
                }).then((result) => {
                    showPenyerahan(
                        $(this).data('noresep'),
                        ...
                        $(this).data('nmdokter'),
                        $(this).data('nmpoli'),
                        $(this).data('jamperesepan'),
                        $(this).data('tglperesepan'),
                    )
                });
            } else {
                showPenyerahan(
                ...
                success: function(response) {
                    ...
                    if (response.code == 200) {
                        ...
                        if (response.penyerahan) {
                            ...
                            if (response.penyerahan.no_tlp == '') {
                                $("#notlppasien").val(response.pasien.no_tlp);
                            } else {
                                $("#notlppasien").val(response.penyerahan.no_tlp);
                        ...
                        row += '<td>:</td>';
                        row += '<td>';
                        row += response.pasien.nm_pasien;
                        row += '<button type="button" id="btnModalPanggil" class="btn btn-sm btn-success btnModalPanggil ms-2"';
                        row += 'data-noresep="' + no_resep + '"';
                        row += 'data-tglperesepan="' + tglperesepan + '"';
                        row += 'data-jamperesepan="' + jamperesepan + '"';
                        row += 'data-norawat="' + no_rawat + '"';
                        row += 'data-norkmmedis="' + response.pasien.no_rkm_medis + '"';
                        row += 'data-nmpasien="' + response.pasien.nm_pasien + '"';
                        row += 'data-kdpoli="' + response.pasien.kd_poli + '"';
                        row += 'data-nmdokter="' + nmdokter + '"';
                        row += 'data-nmpoli="' + nmpoli + '"';
                        row += 'data-jumlahresep="' + 1 + '"';
                        row += 'data-statusrawat="Ralan"';
                        row += '><i class="bi bi-megaphone-fill"></i></button>';
                        row += '</td>';
                        row += '</tr>';
                        row += '<tr>';
        ...
        $('#btnsavepenyerahan').click(function(e) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "/penyerahanobat/postPenyerahanObat",
                        type: 'POST',
                        data: {
                            ...
                            penerima_obat: $("#penerimaobat").val(),
                            ket_penerima_obat: $("#ketpenerimaobat").val(),
                            no_tlp: $("#notlppasien").val(),

                            sign_pasien: sign1.getSignatureImage(),
                            sign_pasien_json: sign1.getSignatureString(),
        ...
        $('#tableResep1').on('click', '.btnSelesai', function() {
            console.log($(this).data('nmpasien'));

            Swal.fire({
                title: 'Apa Anda Yakin?',
                text: "Pasien Akan dipanggil dan status resep akan di ubah ke Terlayani sehingga resep tidak bisa di ubah",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonText: `Yakin`,
                denyButtonText: `Periksa Kembali`,
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "/penyerahanobat/postSelesai",
                        type: 'POST',
                        data: {
                            no_resep: $(this).data('noresep'),
                            no_rawat: $(this).data('norawat'),
                            no_rkm_medis: $(this).data('norkmmedis'),

                            status_rawat: $(this).data('statusrawat'),
                            no_antri: $(this).data('no_antri'),

                            kd_poli: $(this).data('kdpoli'),
                            nm_poli: $(this).data('nmpoli'),
                            nm_pasien: $(this).data('nmpasien'),

                            stts_resep: $(this).data('sttsresep'),

                            tgl_peresepan: $(this).data('tglperesepan'),
                        },
                        dataType: 'json',
                        success: function(response) {
                            console.log(response);
        ...
        $('#tableinformasi').on('click', '.btnModalPanggil', function() {
            $.ajax({
                url: "/penyerahanobat/postSelesai",
                type: 'POST',
                data: {
